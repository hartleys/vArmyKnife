...
## Help for java command "redoDBNSFP"

## USAGE:

    varmyknife [java options] redoDBNSFP [options] variants.vcf dbNSFP3.0b2a.txt.gz outfile.vcf.gz
      or 
    java -jar vArmyKnife.jar [java options] redoDBNSFP [options] variants.vcf dbNSFP3.0b2a.txt.gz outfile.vcf.gz
