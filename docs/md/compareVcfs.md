...
## Help for java command "compareVcfs"

## USAGE:

    varmyknife [java options] compareVcfs [options] variants1.vcf variants2.vcf outfileprefix
      or 
    java -jar vArmyKnife.jar [java options] compareVcfs [options] variants1.vcf variants2.vcf outfileprefix
