...
## Help for java command "AddVariantDomains"

## USAGE:

    varmyknife [java options] AddVariantDomains [options] variants.vcf domainFile.txt domainSummaryOutFile.txt outvcf
      or 
    java -jar vArmyKnife.jar [java options] AddVariantDomains [options] variants.vcf domainFile.txt domainSummaryOutFile.txt outvcf
...
> infput domain info file. (String)


#### domainSummaryOutFile.txt:

> output domain info file. (String)
