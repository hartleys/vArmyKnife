...
## Help for vArmyKnife command "AddVariantDomains"

## USAGE:

GENERAL SYNTAX:

    varmyknife [java_options] --CMD AddVariantDomains [options] variants.vcf domainFile.txt domainSummaryOutFile.txt outvcf
