...
## Help for java command "filterGenotypesByStat"

## USAGE:

    varmyknife [java options] filterGenotypesByStat [options] variants.vcf filterExpr outfile.vcf.gz
      or 
    java -jar vArmyKnife.jar [java options] filterGenotypesByStat [options] variants.vcf filterExpr outfile.vcf.gz
