...
## Help for java command "CreateVariantSampleTableV2"

## USAGE:

    varmyknife [java options] CreateVariantSampleTableV2 [options] variants.vcf outfile.vcf.gz
      or 
    java -jar vArmyKnife.jar [java options] CreateVariantSampleTableV2 [options] variants.vcf outfile.vcf.gz
