...
## Help for java command "CmdAssessACMG"

## USAGE:

    varmyknife [java options] CmdAssessACMG [options] variants.vcf outvcf
      or 
    java -jar vArmyKnife.jar [java options] CmdAssessACMG [options] variants.vcf outvcf
