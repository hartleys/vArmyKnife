...
## Help for java command "GerpTrackToSpans"

## USAGE:

    varmyknife [java options] GerpTrackToSpans [options] infile outfile
      or 
    java -jar vArmyKnife.jar [java options] GerpTrackToSpans [options] infile outfile
