...
## Help for java command "ConvertChromNames"

## USAGE:

    varmyknife [java options] ConvertChromNames [options] variants.vcf chromDecoder.txt outfile.vcf.gz
      or 
    java -jar vArmyKnife.jar [java options] ConvertChromNames [options] variants.vcf chromDecoder.txt outfile.vcf.gz
