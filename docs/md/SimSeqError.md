...
## Help for java command "SimSeqError"

## USAGE:

    varmyknife [java options] SimSeqError [options] input.bam outbam
      or 
    java -jar vArmyKnife.jar [java options] SimSeqError [options] input.bam outbam
