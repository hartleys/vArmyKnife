...
## Help for java command "VcfParserTest"

## USAGE:

    varmyknife [java options] VcfParserTest [options] variants.vcf outfile.vcf.gz
      or 
    java -jar vArmyKnife.jar [java options] VcfParserTest [options] variants.vcf outfile.vcf.gz
