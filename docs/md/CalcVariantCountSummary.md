...
## Help for java command "CalcVariantCountSummary"

## USAGE:

    varmyknife [java options] CalcVariantCountSummary [options] variants.vcf summaryInfo.txt
      or 
    java -jar vArmyKnife.jar [java options] CalcVariantCountSummary [options] variants.vcf summaryInfo.txt
