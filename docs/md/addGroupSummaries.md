...
## Help for java command "addGroupSummaries"

## USAGE:

    varmyknife [java options] addGroupSummaries [options] variants.vcf outvcf
      or 
    java -jar vArmyKnife.jar [java options] addGroupSummaries [options] variants.vcf outvcf
