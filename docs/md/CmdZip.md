...
## Help for java command "CmdZip"

## USAGE:

    varmyknife [java options] CmdZip [options] variants.vcf outfile.vcf.gz
      or 
    java -jar vArmyKnife.jar [java options] CmdZip [options] variants.vcf outfile.vcf.gz
