...
## Help for java command "extractSingletons"

## USAGE:

    varmyknife [java options] extractSingletons [options] variants.vcf outfile.vcf.gz
      or 
    java -jar vArmyKnife.jar [java options] extractSingletons [options] variants.vcf outfile.vcf.gz
