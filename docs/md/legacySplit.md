...
## Help for java command "splitMultiAllelics"

## USAGE:

    varmyknife [java options] splitMultiAllelics [options] variants.vcf outvcf
      or 
    java -jar vArmyKnife.jar [java options] splitMultiAllelics [options] variants.vcf outvcf
