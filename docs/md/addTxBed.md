...
## Help for vArmyKnife command "addTxBed"

## USAGE:

GENERAL SYNTAX:

    varmyknife [java_options] --CMD addTxBed [options] variants.vcf tagID:filedesc:bedfile.bed,tagID2:filedesc2:bedfile2.bed,... outfile.vcf.gz
