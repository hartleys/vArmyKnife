...
## Help for java command "AddCanonicalInfo"

## USAGE:

    varmyknife [java options] AddCanonicalInfo [options] variants.vcf canonicalTxFile.txt outvcf
      or 
    java -jar vArmyKnife.jar [java options] AddCanonicalInfo [options] variants.vcf canonicalTxFile.txt outvcf
