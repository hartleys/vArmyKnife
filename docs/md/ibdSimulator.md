...
## Help for java command "ibdSimulator"

## USAGE:

    varmyknife [java options] ibdSimulator [options] ct outfile.txt
      or 
    java -jar vArmyKnife.jar [java options] ibdSimulator [options] ct outfile.txt
