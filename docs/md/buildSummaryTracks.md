...
## Help for java command "buildSummaryTracks"

## USAGE:

    varmyknife [java options] buildSummaryTracks [options] infile.bam outfile
      or 
    java -jar vArmyKnife.jar [java options] buildSummaryTracks [options] infile.bam outfile
