...
## Help for vArmyKnife command "RemoveUnwantedFields"

## USAGE:

GENERAL SYNTAX:

    varmyknife [java_options] --CMD RemoveUnwantedFields [options] variants.vcf outfile.vcf.gz
...
#### --keepGenotypeTags VAK\_SINGLETON\_ID:
...
#### --keepInfoTags VAK\_SINGLETON\_ID:
