...
## Help for java command "CreateVariantSampleTable"

## USAGE:

    varmyknife [java options] CreateVariantSampleTable [options] variants.vcf outfile.vcf.gz
      or 
    java -jar vArmyKnife.jar [java options] CreateVariantSampleTable [options] variants.vcf outfile.vcf.gz
