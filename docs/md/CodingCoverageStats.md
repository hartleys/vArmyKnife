...
## Help for java command "CodingCoverageStats"

## USAGE:

    varmyknife [java options] CodingCoverageStats [options] infile.bam txdata.txt.gz outfile
      or 
    java -jar vArmyKnife.jar [java options] CodingCoverageStats [options] infile.bam txdata.txt.gz outfile
