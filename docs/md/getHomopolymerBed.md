# vArmyKnife
> Version 3.3.132 (Updated Tue Feb 27 10:24:13 EST 2024)

> ([back to main](../index.html)) ([back to java-utility help](index.html))

## Help for vArmyKnife command "getHomopolymerBed"

## USAGE:

GENERAL SYNTAX:

    varmyknife [java_options] --CMD getHomopolymerBed [options] infile chromLengths.txt outfile.bed.gz
