# vArmyKnife
> Version 2.1.84 (Updated Tue Aug 14 15:42:38 EDT 2018)

> ([back to main](../index.html)) ([back to java-utility help](index.html))

## Help for java command "getHomopolymerBed"

## USAGE:

    varmyknife [java options] getHomopolymerBed [options] infile chromLengths.txt outfile.bed.gz
      or 
    java -jar vArmyKnife.jar [java options] getHomopolymerBed [options] infile chromLengths.txt outfile.bed.gz
...
> Input genome fasta file. (String)


#### chromLengths.txt:

> A simple file containing a list of chromosomes to generate homopolymer runs for. All chromosomes listed MUST be in the input fasta file. (String)


#### outfile.bed.gz:

> The output bed file. Can be gzipped or zipped. (String)
...
> The minimum number of identical base-pairs required in order to qualify as a homopolymer run. (Int)

#### --bufferDist k:

> The flanking distance to mask around a homopolymer run. (Int)
