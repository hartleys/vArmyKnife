...
## Help for java command "RecodeClinVarCLN"

## USAGE:

    varmyknife [java options] RecodeClinVarCLN [options] variants.vcf outvcf
      or 
    java -jar vArmyKnife.jar [java options] RecodeClinVarCLN [options] variants.vcf outvcf
