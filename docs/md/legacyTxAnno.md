...
## Help for java command "addTxInfoToVCF"

## USAGE:

    varmyknife [java options] addTxInfoToVCF [options] variants.vcf gtffile.gtf.gz outfile.vcf.gz
      or 
    java -jar vArmyKnife.jar [java options] addTxInfoToVCF [options] variants.vcf gtffile.gtf.gz outfile.vcf.gz
