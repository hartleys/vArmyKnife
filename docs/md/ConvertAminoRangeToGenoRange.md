...
## Help for vArmyKnife command "ConvertAminoRangeToGenoRange"

## USAGE:

GENERAL SYNTAX:

    varmyknife [java_options] --CMD ConvertAminoRangeToGenoRange [options] infile.txt txdataFile.txt.gz outfile
