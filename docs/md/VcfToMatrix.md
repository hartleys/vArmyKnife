...
## Help for java command "VcfToMatrix"

## USAGE:

    varmyknife [java options] VcfToMatrix [options] infile.vcf.gz outfile.vcf.gz
      or 
    java -jar vArmyKnife.jar [java options] VcfToMatrix [options] infile.vcf.gz outfile.vcf.gz
