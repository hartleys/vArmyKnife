...
## Help for java command "FilterVCF"

## USAGE:

    varmyknife [java options] FilterVCF [options] infile.vcf.gz expr outfile.vcf.gz
      or 
    java -jar vArmyKnife.jar [java options] FilterVCF [options] infile.vcf.gz expr outfile.vcf.gz
...
> The output file or a comma-delimited list of files. Can be gzipped or in plaintext. (String)
